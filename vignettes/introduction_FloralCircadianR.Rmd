...
circadian_file <- system.file("extdata", "example_circadian.csv", package = "FloralCircadianR")
countries_file <- system.file("extdata", "example_countries.csv", package = "FloralCircadianR")

# Read the circadian data
circadian_data <- read_plant_circadian_data(circadian_file)
print(circadian_data)

# Read the list of interested countries
countries <- read_interested_countries(countries_file)
print(countries)
```
...
```{r}
# Analyze the predominant circadian patterns
